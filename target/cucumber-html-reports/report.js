$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Irish.feature");
formatter.feature({
  "line": 1,
  "name": "Gmail application testing",
  "description": "",
  "id": "gmail-application-testing",
  "keyword": "Feature"
});
formatter.scenario({
  "line": 3,
  "name": "Gmail Login Functionality Test",
  "description": "",
  "id": "gmail-application-testing;gmail-login-functionality-test",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
  "line": 4,
  "name": "user opens Irish login page",
  "keyword": "Given "
});
formatter.step({
  "line": 5,
...
formatter.step({
  "line": 8,
  "name": "User_Should_be_logged_in_successfully",
  "keyword": "And "
});
formatter.match({
...
formatter.scenario({
  "line": 10,
  "name": "Search for selenium jobs",
  "description": "",
  "id": "gmail-application-testing;search-for-selenium-jobs",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
  "line": 11,
  "name": "User is logged in to Irishportal",
  "keyword": "Given "
});
formatter.step({
  "line": 12,
  "name": "user enter the keyword",
  "keyword": "Then "
});
formatter.step({
  "line": 13,
...
formatter.scenario({
  "line": 15,
  "name": "to check for dropdown value",
  "description": "",
  "id": "gmail-application-testing;to-check-for-dropdown-value",
  "type": "scenario",
  "keyword": "Scenario"
});
formatter.step({
...
formatter.step({
  "line": 17,
  "name": "Click and select dropdown value",
  "keyword": "Then "
});
formatter.step({
  "line": 18,
  "name": "logged out from the portal",
  "keyword": "And "
});
formatter.step({
  "line": 19,
